...
CREATE TABLE albumns(
    albumn_id INT AUTO_INCREMENT,
    albumn VARCHAR(255) NOT NULL,
...
CREATE TABLE songs(
    ...
    albumn_id INT,
    PRIMARY KEY(song_id),
    FOREIGN KEY(albumn_id) REFERENCES albumns(albumn_id)
) engine = InnoDB;
